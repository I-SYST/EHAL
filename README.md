...
* EHAL is being outgrown. We are gradually moving to the new [IOsonata](https://github.com/IOsonata/IOsonata) in order to support more archtecture & platforms.  Don't worry all the code are the same.  We are only re-organizing the library for easier project integrations in order to response to more demands for other environnements.  Stay tuned.  Thank you for your supports. 
---
